...
namespace probability_even_sum_is_5_11_l2335_233502
...
end probability_even_sum_is_5_11_l2335_233502


namespace intersection_P_Q_l2335_233519
...
end intersection_P_Q_l2335_233519


namespace a_profit_calculation_l2335_233562
...
end a_profit_calculation_l2335_233562


namespace perfect_square_condition_l2335_233581

theorem perfect_square_condition (x : ℤ) : 
  (∃ k : ℤ, x^2 - 14*x - 256 = k^2) ↔ (x = 15 ∨ x = -1) := by
  sorry

end perfect_square_condition_l2335_233581


namespace lcm_48_180_l2335_233533

theorem lcm_48_180 : Nat.lcm 48 180 = 720 := by
  sorry

end lcm_48_180_l2335_233533


namespace h_not_prime_l2335_233566
...
end h_not_prime_l2335_233566


namespace sum_of_specific_terms_l2335_233575
...
end sum_of_specific_terms_l2335_233575


namespace line_circle_intersection_condition_l2335_233529
...
end line_circle_intersection_condition_l2335_233529


namespace fraction_zero_implies_x_negative_one_l2335_233500

theorem fraction_zero_implies_x_negative_one (x : ℝ) :
  (x^2 - 1) / (x - 1) = 0 ∧ x - 1 ≠ 0 → x = -1 := by
sorry

end fraction_zero_implies_x_negative_one_l2335_233500


namespace game_ends_in_56_rounds_l2335_233541
...
end game_ends_in_56_rounds_l2335_233541


namespace acute_triangle_existence_l2335_233568
...
end acute_triangle_existence_l2335_233568


namespace girls_candies_contradiction_l2335_233558
...
end girls_candies_contradiction_l2335_233558


namespace m_range_l2335_233523

theorem m_range (m : ℝ) : 
  (∀ x : ℝ, |x + 1| + |x - 3| ≥ |m - 1|) → m ∈ Set.Icc (-3) 5 := by
sorry

end m_range_l2335_233523


namespace f_period_and_range_l2335_233564
...
end f_period_and_range_l2335_233564


namespace sqrt_fraction_equivalence_l2335_233582

theorem sqrt_fraction_equivalence (x : ℝ) (h : x < 0) :
  Real.sqrt (x / (1 - (x - 4) / x)) = -x / 2 := by
  sorry

end sqrt_fraction_equivalence_l2335_233582


namespace bananas_lost_l2335_233591
...
end bananas_lost_l2335_233591


namespace clown_count_l2335_233561
...
end clown_count_l2335_233561


namespace x_squared_eq_two_is_quadratic_l2335_233567
...
end x_squared_eq_two_is_quadratic_l2335_233567


namespace sum_of_integers_l2335_233587
...
end sum_of_integers_l2335_233587


namespace y_value_l2335_233543

theorem y_value : ∀ y : ℚ, (1 / 3 - 1 / 4 : ℚ) = 4 / y → y = 48 := by
  sorry

end y_value_l2335_233543


namespace complex_fourth_power_magnitude_l2335_233555

theorem complex_fourth_power_magnitude : 
  Complex.abs ((5 + 2 * Complex.I * Real.sqrt 3) ^ 4) = 1369 := by
  sorry

end complex_fourth_power_magnitude_l2335_233555


namespace sum_of_roots_quadratic_equation_l2335_233522

theorem sum_of_roots_quadratic_equation (α β : ℝ) : 
  (α^2 - 4*α + 3 = 0) → (β^2 - 4*β + 3 = 0) → α + β = 4 := by
  sorry

end sum_of_roots_quadratic_equation_l2335_233522


namespace max_ratio_two_digit_mean_55_l2335_233535
...
end max_ratio_two_digit_mean_55_l2335_233535


namespace mrs_wonderful_class_size_l2335_233592
...
end mrs_wonderful_class_size_l2335_233592


namespace right_triangle_third_side_square_l2335_233570
...
end right_triangle_third_side_square_l2335_233570


namespace exradii_sum_equals_p_squared_l2335_233516
...
end exradii_sum_equals_p_squared_l2335_233516


namespace first_trail_length_is_20_l2335_233536
...
end first_trail_length_is_20_l2335_233536


namespace fraction_difference_squared_l2335_233512

theorem fraction_difference_squared (a b : ℝ) (h : 1/a - 1/b = 1/(a + b)) :
  1/a^2 - 1/b^2 = 1/(a*b) := by
  sorry

end fraction_difference_squared_l2335_233512


namespace polynomial_always_positive_l2335_233584

theorem polynomial_always_positive (m : ℝ) : m^6 - m^5 + m^4 + m^2 - m + 1 > 0 := by
  sorry

end polynomial_always_positive_l2335_233584


namespace max_value_of_function_l2335_233505

theorem max_value_of_function (x : ℝ) (h : x ∈ Set.Ioo 0 (1/4)) :
  x * (1 - 4*x) ≤ (1/8) * (1 - 4*(1/8)) :=
sorry

end max_value_of_function_l2335_233505


namespace inequality_proof_l2335_233563

theorem inequality_proof (a b c : ℝ) (h1 : a > b) (h2 : b > c) : 
  (1 : ℝ) / (b - c) > (1 : ℝ) / (a - c) := by
  sorry

end inequality_proof_l2335_233563


namespace fence_cost_for_square_plot_l2335_233572
...
end fence_cost_for_square_plot_l2335_233572


namespace distribute_over_sum_diff_l2335_233526

theorem distribute_over_sum_diff (a b c : ℝ) : a * (a + b - c) = a^2 + a*b - a*c := by
  sorry

end distribute_over_sum_diff_l2335_233526


namespace gdp_scientific_notation_l2335_233553
...
end gdp_scientific_notation_l2335_233553


namespace white_tshirts_per_package_l2335_233508
...
end white_tshirts_per_package_l2335_233508


namespace fox_distribution_l2335_233542
...
end fox_distribution_l2335_233542


namespace polynomial_division_remainder_l2335_233509
...
end polynomial_division_remainder_l2335_233509


namespace flower_pot_cost_difference_l2335_233580
...
end flower_pot_cost_difference_l2335_233580


namespace total_cost_of_gifts_l2335_233507
...
end total_cost_of_gifts_l2335_233507


namespace unanswered_test_completion_ways_l2335_233565
...
end unanswered_test_completion_ways_l2335_233565


namespace sum_of_digits_square_of_ones_l2335_233525
...
end sum_of_digits_square_of_ones_l2335_233525


namespace john_bought_three_spools_l2335_233520
...
end john_bought_three_spools_l2335_233520


namespace log_equation_solutions_are_integers_l2335_233598
...
end log_equation_solutions_are_integers_l2335_233598


namespace tim_balloon_count_l2335_233576
...
end tim_balloon_count_l2335_233576


namespace BF_length_is_150_l2335_233578
...
end BF_length_is_150_l2335_233578


namespace arithmetic_calculation_l2335_233537

theorem arithmetic_calculation : (40 * 30 + (12 + 8) * 3) / 5 = 252 := by
  sorry

end arithmetic_calculation_l2335_233537


namespace lemonade_solution_water_content_l2335_233501
...
end lemonade_solution_water_content_l2335_233501


namespace arithmetic_sequence_properties_l2335_233589
...
end arithmetic_sequence_properties_l2335_233589


namespace quadratic_inequality_l2335_233534
...
end quadratic_inequality_l2335_233534


namespace football_water_cooler_problem_l2335_233527
...
end football_water_cooler_problem_l2335_233527


namespace expected_distinct_colors_value_l2335_233560
...
end expected_distinct_colors_value_l2335_233560


namespace real_y_condition_l2335_233586

theorem real_y_condition (x y : ℝ) : 
  (∃ y, 2 * y^2 + 3 * x * y - x + 8 = 0) ↔ (x ≤ -23/9 ∨ x ≥ 5/3) :=
by sorry

end real_y_condition_l2335_233586


namespace log_x_125_l2335_233593
...
end log_x_125_l2335_233593


namespace money_distribution_l2335_233569
...
end money_distribution_l2335_233569


namespace x_gt_1_necessary_not_sufficient_l2335_233521
...
end x_gt_1_necessary_not_sufficient_l2335_233521


namespace binomial_coefficient_equality_l2335_233511

theorem binomial_coefficient_equality (x : ℕ) : 
  (Nat.choose 20 (2*x - 1) = Nat.choose 20 (x + 3)) → (x = 4 ∨ x = 6) :=
by sorry

end binomial_coefficient_equality_l2335_233511


namespace product_minus_third_lower_bound_l2335_233557
...
end product_minus_third_lower_bound_l2335_233557


namespace cole_math_classes_l2335_233577
...
end cole_math_classes_l2335_233577


namespace asymptote_sum_l2335_233546
...
end asymptote_sum_l2335_233546


namespace angle_between_vectors_l2335_233524
...
end angle_between_vectors_l2335_233524


namespace horner_operation_count_l2335_233585
...
end horner_operation_count_l2335_233585


namespace x_range_l2335_233510
...
end x_range_l2335_233510


namespace fabric_price_system_l2335_233532
...
end fabric_price_system_l2335_233532


namespace initial_average_height_l2335_233574
...
end initial_average_height_l2335_233574


namespace missing_number_proof_l2335_233548

theorem missing_number_proof (a b x : ℕ) (h1 : a = 105) (h2 : b = 147) 
  (h3 : a^3 = x * 25 * 15 * b) : x = 21 := by
  sorry

end missing_number_proof_l2335_233548


namespace tank_filling_flow_rate_l2335_233538
...
end tank_filling_flow_rate_l2335_233538


namespace base4_10201_equals_289_l2335_233595
...
end base4_10201_equals_289_l2335_233595


namespace diophantine_equation_solution_l2335_233550

theorem diophantine_equation_solution (x y : ℤ) : x^4 - 2*y^2 = 1 → x = 1 ∧ y = 0 := by
  sorry

end diophantine_equation_solution_l2335_233550


namespace apples_left_ella_apples_left_l2335_233573
...
end apples_left_ella_apples_left_l2335_233573


namespace triangle_coordinate_l2335_233594
...
end triangle_coordinate_l2335_233594


namespace opposite_of_neg_two_is_two_l2335_233583
...
end opposite_of_neg_two_is_two_l2335_233583


namespace min_flowers_for_bouquets_l2335_233545
...
end min_flowers_for_bouquets_l2335_233545


namespace power_of_two_in_product_l2335_233571
...
end power_of_two_in_product_l2335_233571


namespace sin_cos_relation_l2335_233515

theorem sin_cos_relation (x : Real) (h : Real.sin x = 4 * Real.cos x) :
  Real.sin x * Real.cos x = 4 / 17 := by
  sorry

end sin_cos_relation_l2335_233515


namespace inequality_holds_for_all_reals_l2335_233588

theorem inequality_holds_for_all_reals (x : ℝ) : 4 * x / (x^2 + 4) ≤ 1 := by
  sorry

end inequality_holds_for_all_reals_l2335_233588


namespace min_value_reciprocal_product_l2335_233517
...
end min_value_reciprocal_product_l2335_233517


namespace quadratic_roots_l2335_233514
...
end quadratic_roots_l2335_233514


namespace rectangle_point_characterization_l2335_233599
...
end rectangle_point_characterization_l2335_233599


namespace second_term_of_geometric_sequence_l2335_233559
...
end second_term_of_geometric_sequence_l2335_233559


namespace quadratic_inequality_implies_m_range_l2335_233547

theorem quadratic_inequality_implies_m_range (m : ℝ) :
  (∀ x : ℝ, x^2 - 2*m*x + 1 ≥ 0) → -1 ≤ m ∧ m ≤ 1 := by
  sorry

end quadratic_inequality_implies_m_range_l2335_233547


namespace system_solution_l2335_233597
...
end system_solution_l2335_233597


namespace ellipse_triangle_perimeter_l2335_233540
...
end ellipse_triangle_perimeter_l2335_233540


namespace quadratic_inequality_range_l2335_233528

theorem quadratic_inequality_range (a : ℝ) :
  (∀ x : ℝ, x^2 + 2*a*x + a > 0) → 0 < a ∧ a < 1 := by
  sorry

end quadratic_inequality_range_l2335_233528


namespace balloon_problem_l2335_233506
...
end balloon_problem_l2335_233506


namespace fraction_ordering_l2335_233590

theorem fraction_ordering : 6/29 < 8/25 ∧ 8/25 < 10/31 := by
  sorry

end fraction_ordering_l2335_233590


namespace division_remainder_l2335_233518
...
end division_remainder_l2335_233518


namespace trigonometric_sum_equals_sqrt_two_l2335_233544
...
end trigonometric_sum_equals_sqrt_two_l2335_233544


namespace quadratic_root_one_l2335_233504

theorem quadratic_root_one (a b c : ℝ) (h1 : a - b + c = 0) (h2 : a ≠ 0) :
  ∃ x : ℝ, a * x^2 - b * x + c = 0 ∧ x = 1 := by
  sorry

end quadratic_root_one_l2335_233504


namespace similarity_circle_theorem_l2335_233503
...
end similarity_circle_theorem_l2335_233503


namespace reflection_of_P_across_x_axis_l2335_233552
...
end reflection_of_P_across_x_axis_l2335_233552


namespace marble_percentage_theorem_l2335_233513
...
end marble_percentage_theorem_l2335_233513


namespace percentage_problem_l2335_233554

theorem percentage_problem (n : ℝ) : 0.15 * 0.30 * 0.50 * n = 90 → n = 4000 := by
  sorry

end percentage_problem_l2335_233554


namespace tangent_circles_count_l2335_233549
...
end tangent_circles_count_l2335_233549


namespace append_self_perfect_square_l2335_233530
...
end append_self_perfect_square_l2335_233530


namespace sphere_triangle_distance_l2335_233556
...
end sphere_triangle_distance_l2335_233556


namespace reference_city_stores_l2335_233579
...
end reference_city_stores_l2335_233579


namespace parallel_lines_a_value_l2335_233531
...
end parallel_lines_a_value_l2335_233531


namespace sin_plus_cos_eq_one_solutions_l2335_233539

theorem sin_plus_cos_eq_one_solutions (x : Real) : 
  0 ≤ x ∧ x < 2 * Real.pi → (Real.sin x + Real.cos x = 1 ↔ x = 0 ∨ x = Real.pi / 2) := by
  sorry

end sin_plus_cos_eq_one_solutions_l2335_233539


namespace yard_length_26_trees_l2335_233596
...
end yard_length_26_trees_l2335_233596


namespace transportation_problem_l2335_233551
...
end transportation_problem_l2335_233551
