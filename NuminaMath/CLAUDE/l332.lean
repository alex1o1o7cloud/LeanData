...
namespace min_value_problem_l332_33239
...
end min_value_problem_l332_33239


namespace abigail_money_problem_l332_33252
...
end abigail_money_problem_l332_33252


namespace point_A_satisfies_condition_l332_33200
...
end point_A_satisfies_condition_l332_33200


namespace smallest_value_x_plus_inv_x_l332_33293

theorem smallest_value_x_plus_inv_x (x : ℝ) (h : 11 = x^2 + 1/x^2) :
  ∃ y : ℝ, y = x + 1/x ∧ y ≥ -Real.sqrt 13 ∧ (∀ z : ℝ, z = x + 1/x → z ≥ y) :=
by sorry

end smallest_value_x_plus_inv_x_l332_33293


namespace percentage_problem_l332_33297
...
end percentage_problem_l332_33297


namespace least_cars_per_day_l332_33231
...
end least_cars_per_day_l332_33231


namespace sequence_increasing_iff_last_term_l332_33218
...
end sequence_increasing_iff_last_term_l332_33218


namespace equation_solution_l332_33208

theorem equation_solution :
  ∃ y : ℝ, y - 9 / (y - 4) = 2 - 9 / (y - 4) ∧ y = 2 :=
by sorry

end equation_solution_l332_33208


namespace opposite_side_length_l332_33287
...
end opposite_side_length_l332_33287


namespace certain_number_problem_l332_33211

theorem certain_number_problem (p q : ℕ) (x : ℤ) : 
  p > 1 → q > 1 → p + q = 36 → x * (p + 1) = 21 * (q + 1) → x = 245 := by
  sorry

end certain_number_problem_l332_33211


namespace textbook_order_cost_l332_33278
...
end textbook_order_cost_l332_33278


namespace max_daily_revenue_l332_33219
...
end max_daily_revenue_l332_33219


namespace distinct_polygons_from_circle_points_l332_33255

theorem distinct_polygons_from_circle_points (n : ℕ) (h : n = 12) : 
  (2^n : ℕ) - (1 + n + n*(n-1)/2) = 4017 := by
  sorry

end distinct_polygons_from_circle_points_l332_33255


namespace restaurant_glasses_problem_l332_33243
...
end restaurant_glasses_problem_l332_33243


namespace hyperbola_asymptote_l332_33250
...
end hyperbola_asymptote_l332_33250


namespace softball_team_size_l332_33288
...
end softball_team_size_l332_33288


namespace symmetric_point_coordinates_l332_33295
...
end symmetric_point_coordinates_l332_33295


namespace parabola_symmetry_l332_33216
...
end parabola_symmetry_l332_33216


namespace set_equalities_l332_33238
...
end set_equalities_l332_33238


namespace basic_astrophysics_degrees_l332_33229
...
end basic_astrophysics_degrees_l332_33229


namespace tan_seven_pi_fourth_l332_33247

theorem tan_seven_pi_fourth : Real.tan (7 * π / 4) = -1 := by
  sorry

end tan_seven_pi_fourth_l332_33247


namespace intersection_implies_z_l332_33215
...
end intersection_implies_z_l332_33215


namespace parabola_and_line_intersection_l332_33205
...
end parabola_and_line_intersection_l332_33205


namespace piano_lesson_cost_l332_33269
...
end piano_lesson_cost_l332_33269


namespace parallel_lines_j_value_l332_33296
...
end parallel_lines_j_value_l332_33296


namespace anais_toy_difference_l332_33282
...
end anais_toy_difference_l332_33282


namespace tangent_points_on_line_l332_33268
...
end tangent_points_on_line_l332_33268


namespace solution_sets_equality_l332_33281

theorem solution_sets_equality (b c : ℝ) : 
  (∀ x : ℝ, |2*x - 3| < 5 ↔ -x^2 + b*x + c > 0) → b + c = 7 := by
  sorry

end solution_sets_equality_l332_33281


namespace tangency_point_l332_33248
...
end tangency_point_l332_33248


namespace a_2_equals_3_l332_33285
...
end a_2_equals_3_l332_33285


namespace eggs_from_martha_l332_33254
...
end eggs_from_martha_l332_33254


namespace room_length_proof_l332_33290
...
end room_length_proof_l332_33290


namespace incorrect_mark_is_83_l332_33256
...
end incorrect_mark_is_83_l332_33256


namespace lotus_pollen_diameter_scientific_notation_l332_33272

theorem lotus_pollen_diameter_scientific_notation :
  ∃ (a : ℝ) (n : ℤ), 0.0025 = a * (10 : ℝ) ^ n ∧ 1 ≤ a ∧ a < 10 ∧ a = 2.5 ∧ n = -3 := by
  sorry

end lotus_pollen_diameter_scientific_notation_l332_33272


namespace richard_twice_scott_age_david_age_four_years_ago_future_years_correct_l332_33201
...
end richard_twice_scott_age_david_age_four_years_ago_future_years_correct_l332_33201


namespace sum_of_fractions_inequality_equality_condition_l332_33227
...
end sum_of_fractions_inequality_equality_condition_l332_33227


namespace least_number_with_remainder_l332_33251
...
end least_number_with_remainder_l332_33251


namespace intersection_line_l332_33266
...
end intersection_line_l332_33266


namespace larger_cuboid_height_l332_33253
...
end larger_cuboid_height_l332_33253


namespace distinct_prime_factors_of_sum_of_divisors_450_l332_33289
...
end distinct_prime_factors_of_sum_of_divisors_450_l332_33289


namespace min_framing_feet_l332_33246
...
end min_framing_feet_l332_33246


namespace complement_M_l332_33224
...
end complement_M_l332_33224


namespace inequality_equivalence_l332_33214

theorem inequality_equivalence (x : ℝ) : (x - 1) / 2 + 1 < (4 * x - 5) / 3 ↔ x > 13 / 5 := by
  sorry

end inequality_equivalence_l332_33214


namespace equidistant_point_on_x_axis_l332_33206
...
end equidistant_point_on_x_axis_l332_33206


namespace inequality_system_solution_l332_33207

theorem inequality_system_solution :
  ∀ x : ℝ, (2 * x + 1 < 5 ∧ 3 - x > 2) ↔ x < 1 := by
  sorry

end inequality_system_solution_l332_33207


namespace fenced_area_calculation_l332_33241
...
end fenced_area_calculation_l332_33241


namespace white_area_theorem_l332_33299
...
end white_area_theorem_l332_33299


namespace quadratic_two_distinct_roots_l332_33262
...
end quadratic_two_distinct_roots_l332_33262


namespace largest_power_2024_divides_factorial_l332_33273
...
end largest_power_2024_divides_factorial_l332_33273


namespace expression_value_at_12_l332_33221
...
end expression_value_at_12_l332_33221


namespace pen_purchase_price_l332_33258
...
end pen_purchase_price_l332_33258


namespace perpendicular_vectors_difference_magnitude_l332_33233
...
end perpendicular_vectors_difference_magnitude_l332_33233


namespace intersection_values_eq_two_eight_l332_33261
...
end intersection_values_eq_two_eight_l332_33261


namespace container_volume_ratio_l332_33222
...
end container_volume_ratio_l332_33222


namespace arithmetic_sequence_sum_l332_33274
...
end arithmetic_sequence_sum_l332_33274


namespace function_equality_l332_33234
...
end function_equality_l332_33234


namespace max_m_inequality_l332_33210

theorem max_m_inequality (a b : ℝ) (ha : a > 0) (hb : b > 0) (h : 2 / a + 1 / b = 1 / 4) :
  (∀ m : ℝ, 2 * a + b ≥ 4 * m) → (∃ m : ℝ, m = 9 ∧ 2 * a + b = 4 * m) :=
by sorry

end max_m_inequality_l332_33210


namespace raja_income_proof_l332_33242
...
end raja_income_proof_l332_33242


namespace max_min_x_plus_y_l332_33217
...
end max_min_x_plus_y_l332_33217


namespace prob_sum_nine_l332_33228
...
end prob_sum_nine_l332_33228


namespace total_interest_calculation_l332_33277
...
end total_interest_calculation_l332_33277


namespace problem_solution_l332_33294
...
end problem_solution_l332_33294


namespace basket_probability_l332_33271
...
end basket_probability_l332_33271


namespace quadratic_function_properties_l332_33298
...
end quadratic_function_properties_l332_33298


namespace equation_a_graph_l332_33213

theorem equation_a_graph (x y : ℝ) :
  (x - 2) * (y + 3) = 0 ↔ (x = 2 ∨ y = -3) :=
sorry

end equation_a_graph_l332_33213


namespace first_number_proof_l332_33283

theorem first_number_proof (x : ℝ) : 
  (((10 + 60 + 35) / 3) + 5 = (x + 40 + 60) / 3) → x = 20 := by
  sorry

end first_number_proof_l332_33283


namespace cube_net_theorem_l332_33249
...
end cube_net_theorem_l332_33249


namespace cake_calories_l332_33209
...
end cake_calories_l332_33209


namespace race_distance_l332_33203
...
end race_distance_l332_33203


namespace set_inclusion_implies_parameter_range_l332_33240
...
end set_inclusion_implies_parameter_range_l332_33240


namespace smallest_angle_range_l332_33275
...
end smallest_angle_range_l332_33275


namespace total_car_parts_cost_l332_33245
...
end total_car_parts_cost_l332_33245


namespace grocery_expense_l332_33259
...
end grocery_expense_l332_33259


namespace inequality_proof_l332_33257
...
end inequality_proof_l332_33257


namespace perpendicular_vectors_m_value_l332_33286
...
end perpendicular_vectors_m_value_l332_33286


namespace tan_alpha_and_tan_alpha_minus_pi_fourth_l332_33236
...
end tan_alpha_and_tan_alpha_minus_pi_fourth_l332_33236


namespace hyperbola_foci_coordinates_l332_33270
...
end hyperbola_foci_coordinates_l332_33270


namespace jerry_earnings_l332_33292
...
end jerry_earnings_l332_33292


namespace geometric_sequence_product_l332_33212
...
end geometric_sequence_product_l332_33212


namespace intersection_when_p_zero_union_equals_B_implies_p_range_l332_33204
...
end intersection_when_p_zero_union_equals_B_implies_p_range_l332_33204


namespace ellipse_eccentricity_l332_33223
...
end ellipse_eccentricity_l332_33223


namespace salary_distribution_difference_l332_33235
...
end salary_distribution_difference_l332_33235


namespace abcd_product_magnitude_l332_33284
...
end abcd_product_magnitude_l332_33284


namespace intersection_points_theorem_l332_33202
...
end intersection_points_theorem_l332_33202


namespace turban_price_gopi_servant_l332_33265
...
end turban_price_gopi_servant_l332_33265


namespace binary_multiplication_l332_33267
...
end binary_multiplication_l332_33267


namespace farmer_children_count_l332_33244
...
end farmer_children_count_l332_33244


namespace arrangementsWithRestrictionsCorrect_l332_33263
...
end arrangementsWithRestrictionsCorrect_l332_33263


namespace pool_filling_problem_l332_33276
...
end pool_filling_problem_l332_33276


namespace fraction_value_l332_33279
...
end fraction_value_l332_33279


namespace powerjet_45min_output_l332_33225
...
end powerjet_45min_output_l332_33225


namespace product_inequality_l332_33260
...
end product_inequality_l332_33260


namespace max_value_implies_m_l332_33264
...
end max_value_implies_m_l332_33264


namespace prime_order_existence_l332_33232
...
end prime_order_existence_l332_33232


namespace milk_parts_in_drink_A_l332_33220
...
end milk_parts_in_drink_A_l332_33220


namespace spencer_walk_distance_l332_33237
...
end spencer_walk_distance_l332_33237


namespace complete_residue_system_l332_33226
...
end complete_residue_system_l332_33226


namespace girls_in_selection_l332_33230

theorem girls_in_selection (n : ℕ) : 
  (1 - (Nat.choose 3 3 : ℚ) / (Nat.choose (3 + n) 3 : ℚ) = 34 / 35) → n = 4 :=
by sorry

end girls_in_selection_l332_33230


namespace smallest_x_value_l332_33280

theorem smallest_x_value (y : ℕ+) (x : ℕ+) (h : (3 : ℚ) / 4 = (y : ℚ) / ((250 : ℚ) + x)) :
  x ≥ 2 ∧ ∃ (y' : ℕ+), (3 : ℚ) / 4 = (y' : ℚ) / ((250 : ℚ) + 2) :=
by sorry

end smallest_x_value_l332_33280


namespace polynomial_nonnegative_iff_equal_roots_l332_33291
...
end polynomial_nonnegative_iff_equal_roots_l332_33291
