...
namespace jihye_marbles_l461_46167
...
end jihye_marbles_l461_46167


namespace ab_bounds_l461_46125
...
end ab_bounds_l461_46125


namespace symmetric_points_sum_power_l461_46113
...
end symmetric_points_sum_power_l461_46113


namespace final_sparrow_count_l461_46122
...
end final_sparrow_count_l461_46122


namespace average_of_averages_l461_46136
...
end average_of_averages_l461_46136


namespace unique_solution_to_equation_l461_46170

theorem unique_solution_to_equation : 
  ∀ a b : ℝ, 2 * (a^2 + 1) * (b^2 + 1) = (a + 1) * (b + 1) * (a * b + 1) → a = 1 ∧ b = 1 :=
by sorry

end unique_solution_to_equation_l461_46170


namespace chess_matches_to_reach_target_percentage_l461_46192
...
end chess_matches_to_reach_target_percentage_l461_46192


namespace tricycle_wheel_revolutions_l461_46126
...
end tricycle_wheel_revolutions_l461_46126


namespace hyperbola_angle_in_fourth_quadrant_l461_46152
...
end hyperbola_angle_in_fourth_quadrant_l461_46152


namespace max_sum_xyz_l461_46186
...
end max_sum_xyz_l461_46186


namespace matrix_multiplication_l461_46168
...
end matrix_multiplication_l461_46168


namespace solution_set_of_even_increasing_function_l461_46121
...
end solution_set_of_even_increasing_function_l461_46121


namespace smallest_valid_number_last_four_digits_l461_46182
...
end smallest_valid_number_last_four_digits_l461_46182


namespace average_weight_increase_l461_46108
...
end average_weight_increase_l461_46108


namespace curve_and_line_properties_l461_46147
...
end curve_and_line_properties_l461_46147


namespace bill_share_calculation_l461_46187
...
end bill_share_calculation_l461_46187


namespace game_result_l461_46132
...
end game_result_l461_46132


namespace unique_stickers_count_l461_46130
...
end unique_stickers_count_l461_46130


namespace tire_sample_size_l461_46105

theorem tire_sample_size (p : ℝ) (n : ℕ) (h1 : p = 0.015) (h2 : n = 168) :
  1 - (1 - p) ^ n > 0.92 := by
  sorry

end tire_sample_size_l461_46105


namespace cube_plus_reciprocal_cube_l461_46104

theorem cube_plus_reciprocal_cube (r : ℝ) (h : (r + 1/r)^2 = 5) :
  r^3 + 1/r^3 = 2 * Real.sqrt 5 := by
  sorry

end cube_plus_reciprocal_cube_l461_46104


namespace cos_angle_BHD_value_l461_46174
...
end cos_angle_BHD_value_l461_46174


namespace all_points_on_same_circle_l461_46153
...
end all_points_on_same_circle_l461_46153


namespace function_pair_properties_l461_46165
...
end function_pair_properties_l461_46165


namespace initial_mean_calculation_l461_46164
...
end initial_mean_calculation_l461_46164


namespace number_of_roses_rose_count_proof_l461_46162
...
end number_of_roses_rose_count_proof_l461_46162


namespace barbed_wire_rate_proof_l461_46133
...
end barbed_wire_rate_proof_l461_46133


namespace no_real_solutions_l461_46151

theorem no_real_solutions : ¬∃ (x : ℝ), (x^3 - x^2 - 4*x)/(x^2 + 5*x + 6) + 2*x = -6 := by
  sorry

end no_real_solutions_l461_46151


namespace parents_age_at_marks_birth_l461_46146
...
end parents_age_at_marks_birth_l461_46146


namespace equation_solution_l461_46156

theorem equation_solution (r : ℚ) (h1 : r ≠ 2) (h2 : r ≠ -1) :
  (r + 3) / (r - 2) = (r - 1) / (r + 1) ↔ r = -1/7 := by
  sorry

end equation_solution_l461_46156


namespace dihedral_angle_adjacent_faces_l461_46189
...
end dihedral_angle_adjacent_faces_l461_46189


namespace locus_of_M_l461_46161
...
end locus_of_M_l461_46161


namespace division_problem_l461_46110
...
end division_problem_l461_46110


namespace certain_amount_problem_l461_46127

theorem certain_amount_problem (x y : ℝ) : 
  x = 7 → x + y = 15 → 5 * y - 3 * x = 19 := by
  sorry

end certain_amount_problem_l461_46127


namespace rohan_investment_is_8040_l461_46177
...
end rohan_investment_is_8040_l461_46177


namespace joan_money_proof_l461_46150
...
end joan_money_proof_l461_46150


namespace missing_element_is_five_l461_46118
...
end missing_element_is_five_l461_46118


namespace max_value_theorem_l461_46137
...
end max_value_theorem_l461_46137


namespace opposite_reciprocal_sum_l461_46131
...
end opposite_reciprocal_sum_l461_46131


namespace tyson_jenna_meeting_l461_46145
...
end tyson_jenna_meeting_l461_46145


namespace total_athletes_count_l461_46103
...
end total_athletes_count_l461_46103


namespace complement_of_A_l461_46144
...
end complement_of_A_l461_46144


namespace fewer_onions_l461_46135
...
end fewer_onions_l461_46135


namespace institutions_made_happy_l461_46197
...
end institutions_made_happy_l461_46197


namespace boat_half_speed_time_and_distance_l461_46120
...
end boat_half_speed_time_and_distance_l461_46120


namespace walkway_area_is_296_l461_46123
...
end walkway_area_is_296_l461_46123


namespace garbage_collection_difference_l461_46111
...
end garbage_collection_difference_l461_46111


namespace sundae_price_l461_46175
...
end sundae_price_l461_46175


namespace tom_final_book_count_l461_46139
...
end tom_final_book_count_l461_46139


namespace green_turtles_count_l461_46115
...
end green_turtles_count_l461_46115


namespace perfect_square_condition_l461_46180
...
end perfect_square_condition_l461_46180


namespace difference_of_squares_problem_1_problem_2_l461_46160
...
end difference_of_squares_problem_1_problem_2_l461_46160


namespace split_eggs_into_groups_l461_46196
...
end split_eggs_into_groups_l461_46196


namespace cube_edge_length_from_circumscribed_sphere_volume_l461_46191
...
end cube_edge_length_from_circumscribed_sphere_volume_l461_46191


namespace a_gt_2_necessary_not_sufficient_for_a_gt_5_l461_46183
...
end a_gt_2_necessary_not_sufficient_for_a_gt_5_l461_46183


namespace complex_on_real_axis_l461_46138

theorem complex_on_real_axis (a b : ℝ) : 
  (Complex.ofReal a + Complex.I * b).im = 0 → b = 0 := by
  sorry

end complex_on_real_axis_l461_46138


namespace polynomial_division_remainder_l461_46148

theorem polynomial_division_remainder : ∃ q : Polynomial ℝ, 
  3 * X^2 - 16 * X + 38 = (X - 4) * q + 22 := by
  sorry

end polynomial_division_remainder_l461_46148


namespace point_classification_l461_46193
...
end point_classification_l461_46193


namespace equation_solution_l461_46141
...
end equation_solution_l461_46141


namespace second_number_equation_l461_46142
...
end second_number_equation_l461_46142


namespace function_satisfies_conditions_l461_46154
...
end function_satisfies_conditions_l461_46154


namespace complex_fraction_calculation_l461_46143

theorem complex_fraction_calculation (z : ℂ) (h : z = 1 - I) : z^2 / (z - 1) = 2 := by
  sorry

end complex_fraction_calculation_l461_46143


namespace exists_divisible_by_three_l461_46172
...
end exists_divisible_by_three_l461_46172


namespace unique_pair_no_real_solutions_l461_46119
...
end unique_pair_no_real_solutions_l461_46119


namespace find_y_l461_46100

theorem find_y (x : ℝ) (y : ℝ) (h1 : 1.5 * x = 0.3 * y) (h2 : x = 20) : y = 100 := by
  sorry

end find_y_l461_46100


namespace cos_alpha_plus_5pi_12_l461_46109

theorem cos_alpha_plus_5pi_12 (α : Real) (h : Real.sin (α - π / 12) = 1 / 3) :
  Real.cos (α + 5 * π / 12) = -1 / 3 := by
  sorry

end cos_alpha_plus_5pi_12_l461_46109


namespace line_circle_intersection_l461_46179
...
end line_circle_intersection_l461_46179


namespace bag_balls_count_l461_46198
...
end bag_balls_count_l461_46198


namespace max_value_bound_max_value_achievable_l461_46155
...
end max_value_bound_max_value_achievable_l461_46155


namespace school_students_count_l461_46114
...
end school_students_count_l461_46114


namespace tennis_balls_order_l461_46116
...
end tennis_balls_order_l461_46116


namespace aquarium_count_l461_46173
...
end aquarium_count_l461_46173


namespace one_true_proposition_l461_46190
...
end one_true_proposition_l461_46190


namespace volume_removed_tetrahedra_l461_46171
...
end volume_removed_tetrahedra_l461_46171


namespace walking_running_distance_ratio_l461_46188
...
end walking_running_distance_ratio_l461_46188


namespace ball_hitting_ground_time_l461_46184
...
end ball_hitting_ground_time_l461_46184


namespace theo_selling_price_l461_46185
...
end theo_selling_price_l461_46185


namespace scientific_notation_of_280_million_l461_46124

theorem scientific_notation_of_280_million :
  ∃ (a : ℝ) (n : ℤ), 1 ≤ a ∧ a < 10 ∧ 280000000 = a * (10 : ℝ) ^ n ∧ a = 2.8 ∧ n = 8 := by
  sorry

end scientific_notation_of_280_million_l461_46124


namespace functional_equation_solution_l461_46166
...
end functional_equation_solution_l461_46166


namespace inverse_difference_theorem_l461_46195

theorem inverse_difference_theorem (a b : ℝ) (ha : a ≠ 0) (hb : b ≠ 0) (h : 3 * a - b / 3 ≠ 0) :
  (3 * a - b / 3)⁻¹ * ((3 * a)⁻¹ - (b / 3)⁻¹) = -(a⁻¹ * b⁻¹) := by
  sorry

end inverse_difference_theorem_l461_46195


namespace yellow_balls_count_l461_46117
...
end yellow_balls_count_l461_46117


namespace compound_weight_is_334_13_l461_46157
...
end compound_weight_is_334_13_l461_46157


namespace expression_value_l461_46163

theorem expression_value (p q r : ℝ) (hp : p ≠ 2) (hq : q ≠ 3) (hr : r ≠ 4) :
  (p^2 - 4) / (4 - r^2) * (q^2 - 9) / (2 - p^2) * (r^2 - 16) / (3 - q^2) = -1 := by
  sorry

end expression_value_l461_46163


namespace unique_p_value_l461_46159
...
end unique_p_value_l461_46159


namespace M_intersect_N_equals_open_interval_l461_46169
...
end M_intersect_N_equals_open_interval_l461_46169


namespace opposite_numbers_l461_46176
...
end opposite_numbers_l461_46176


namespace point_on_lines_abs_diff_zero_l461_46158
...
end point_on_lines_abs_diff_zero_l461_46158


namespace remaining_onions_l461_46149
...
end remaining_onions_l461_46149


namespace max_rectangular_pen_area_l461_46178
...
end max_rectangular_pen_area_l461_46178


namespace arrangement_counts_l461_46194
...
end arrangement_counts_l461_46194


namespace k_value_l461_46140
...
end k_value_l461_46140


namespace ketchup_mustard_arrangement_l461_46181
...
end ketchup_mustard_arrangement_l461_46181


namespace airline_wireless_internet_percentage_l461_46107
...
end airline_wireless_internet_percentage_l461_46107


namespace algebraic_expression_equality_l461_46106

theorem algebraic_expression_equality (x y : ℝ) (h : x + 2*y = 2) : 2*x + 4*y - 1 = 3 := by
  sorry

end algebraic_expression_equality_l461_46106


namespace a_profit_share_l461_46128
...
end a_profit_share_l461_46128


namespace tan_negative_seven_pi_sixths_l461_46129

theorem tan_negative_seven_pi_sixths : 
  Real.tan (-7 * π / 6) = -1 / Real.sqrt 3 := by
  sorry

end tan_negative_seven_pi_sixths_l461_46129


namespace sum_of_coefficients_l461_46102
...
end sum_of_coefficients_l461_46102


namespace undefined_fraction_l461_46112
...
end undefined_fraction_l461_46112


namespace zero_exponent_l461_46101

theorem zero_exponent (x : ℝ) (h : x ≠ 0) : x^0 = 1 := by sorry

end zero_exponent_l461_46101


namespace probability_three_common_books_l461_46134
...
end probability_three_common_books_l461_46134


namespace minimum_value_implies_a_l461_46199
...
end minimum_value_implies_a_l461_46199
