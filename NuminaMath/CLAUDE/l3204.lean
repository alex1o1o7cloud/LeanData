...
namespace minimum_discount_rate_correct_l3204_320494
...
end minimum_discount_rate_correct_l3204_320494


namespace right_triangle_ratio_bound_l3204_320436
...
end right_triangle_ratio_bound_l3204_320436


namespace tony_age_at_period_end_l3204_320446
...
end tony_age_at_period_end_l3204_320446


namespace tangent_circle_radius_l3204_320491
...
end tangent_circle_radius_l3204_320491


namespace square_circle_union_area_l3204_320412
...
end square_circle_union_area_l3204_320412


namespace profit_percent_from_cost_price_ratio_l3204_320417
...
end profit_percent_from_cost_price_ratio_l3204_320417


namespace safe_journey_possible_l3204_320453
...
end safe_journey_possible_l3204_320453


namespace alloy_composition_proof_l3204_320400
...
end alloy_composition_proof_l3204_320400


namespace years_calculation_l3204_320496
...
end years_calculation_l3204_320496


namespace z_greater_than_w_by_50_percent_l3204_320402
...
end z_greater_than_w_by_50_percent_l3204_320402


namespace complex_subtraction_l3204_320420

theorem complex_subtraction (c d : ℂ) (hc : c = 5 - 3*I) (hd : d = 2 + 4*I) :
  c - 3*d = -1 - 15*I := by
  sorry

end complex_subtraction_l3204_320420


namespace negation_divisible_by_two_even_l3204_320426

theorem negation_divisible_by_two_even :
  (¬ ∀ n : ℤ, 2 ∣ n → Even n) ↔ (∃ n : ℤ, 2 ∣ n ∧ ¬ Even n) :=
by sorry

end negation_divisible_by_two_even_l3204_320426


namespace cubic_poly_roots_theorem_l3204_320409
...
end cubic_poly_roots_theorem_l3204_320409


namespace arithmetic_calculations_l3204_320459
...
end arithmetic_calculations_l3204_320459


namespace quadratic_sum_l3204_320492
...
end quadratic_sum_l3204_320492


namespace unique_k_for_rational_solutions_l3204_320429
...
end unique_k_for_rational_solutions_l3204_320429


namespace polynomial_factorization_l3204_320475

theorem polynomial_factorization (x a : ℝ) : 
  x^3 - 3*x^2 + (a+2)*x - 2*a = (x^2 - x + a)*(x - 2) := by
  sorry

end polynomial_factorization_l3204_320475


namespace sin_thirteen_pi_fourths_l3204_320484

theorem sin_thirteen_pi_fourths : Real.sin (13 * π / 4) = -Real.sqrt 2 / 2 := by
  sorry

end sin_thirteen_pi_fourths_l3204_320484


namespace common_chord_length_l3204_320408
...
end common_chord_length_l3204_320408


namespace revenue_difference_l3204_320463
...
end revenue_difference_l3204_320463


namespace solution_is_3_minus_i_l3204_320450
...
end solution_is_3_minus_i_l3204_320450


namespace proportional_segments_l3204_320474

theorem proportional_segments (a : ℝ) :
  (a > 0) → ((a / 2) = (6 / (a + 1))) → a = 3 := by
  sorry

end proportional_segments_l3204_320474


namespace c_used_car_for_11_hours_l3204_320473
...
end c_used_car_for_11_hours_l3204_320473


namespace max_gcd_of_product_600_l3204_320433
...
end max_gcd_of_product_600_l3204_320433


namespace max_satiated_pikes_l3204_320437
...
end max_satiated_pikes_l3204_320437


namespace geometric_sequence_sixth_term_l3204_320403
...
end geometric_sequence_sixth_term_l3204_320403


namespace tan_45_degrees_equals_one_l3204_320421

theorem tan_45_degrees_equals_one :
  Real.tan (π / 4) = 1 := by
  sorry

end tan_45_degrees_equals_one_l3204_320421


namespace traffic_light_probabilities_l3204_320483
...
end traffic_light_probabilities_l3204_320483


namespace mary_earnings_l3204_320404
...
end mary_earnings_l3204_320404


namespace total_area_of_triangles_l3204_320434
...
end total_area_of_triangles_l3204_320434


namespace imaginary_axis_length_of_given_hyperbola_l3204_320498
...
end imaginary_axis_length_of_given_hyperbola_l3204_320498


namespace part1_solution_part2_solution_l3204_320464
...
end part1_solution_part2_solution_l3204_320464


namespace factors_of_243_l3204_320448

theorem factors_of_243 : Finset.card (Nat.divisors 243) = 6 := by
  sorry

end factors_of_243_l3204_320448


namespace not_sufficient_not_necessary_squared_inequality_l3204_320489

theorem not_sufficient_not_necessary_squared_inequality (a b : ℝ) :
  (∃ x y : ℝ, x > y ∧ x^2 ≤ y^2) ∧ (∃ u v : ℝ, u^2 > v^2 ∧ u ≤ v) := by
  sorry

end not_sufficient_not_necessary_squared_inequality_l3204_320489


namespace no_fixed_points_iff_negative_discriminant_l3204_320468
...
end no_fixed_points_iff_negative_discriminant_l3204_320468


namespace probability_in_standard_deck_l3204_320442
...
end probability_in_standard_deck_l3204_320442


namespace f_4_equals_40_l3204_320411
...
end f_4_equals_40_l3204_320411


namespace unemployment_forecast_l3204_320480
...
end unemployment_forecast_l3204_320480


namespace total_cost_is_2075_l3204_320472
...
end total_cost_is_2075_l3204_320472


namespace interior_alternate_angles_parallel_l3204_320457
...
end interior_alternate_angles_parallel_l3204_320457


namespace jane_albert_same_committee_l3204_320431
...
end jane_albert_same_committee_l3204_320431


namespace line_perpendicular_condition_l3204_320443
...
end line_perpendicular_condition_l3204_320443


namespace next_interval_is_two_point_five_l3204_320444
...
end next_interval_is_two_point_five_l3204_320444


namespace regular_polygon_vertices_l3204_320415
...
end regular_polygon_vertices_l3204_320415


namespace arithmetic_sequence_middle_term_l3204_320441
...
end arithmetic_sequence_middle_term_l3204_320441


namespace letter_e_to_square_l3204_320414
...
end letter_e_to_square_l3204_320414


namespace quadratic_roots_ratio_l3204_320478
...
end quadratic_roots_ratio_l3204_320478


namespace milk_for_nine_cookies_l3204_320447
...
end milk_for_nine_cookies_l3204_320447


namespace simplify_trig_expression_l3204_320467
...
end simplify_trig_expression_l3204_320467


namespace sequence_properties_l3204_320470
...
end sequence_properties_l3204_320470


namespace problem_solution_l3204_320432

theorem problem_solution (p q : Prop) (hp : 1 > -2) (hq : Even 2) : 
  (p ∨ q) ∧ (p ∧ q) ∧ ¬(¬p) := by
  sorry

end problem_solution_l3204_320432


namespace arithmetic_expression_equality_l3204_320451

theorem arithmetic_expression_equality : 
  1 / 2 + ((2 / 3 * 3 / 8) + 4) - 8 / 16 = 17 / 4 := by
  sorry

end arithmetic_expression_equality_l3204_320451


namespace vector_magnitude_problem_l3204_320477
...
end vector_magnitude_problem_l3204_320477


namespace number_relation_l3204_320445
...
end number_relation_l3204_320445


namespace problem_statement_l3204_320499
...
end problem_statement_l3204_320499


namespace point_M_coordinates_l3204_320471
...
end point_M_coordinates_l3204_320471


namespace smallest_y_for_prime_abs_quadratic_l3204_320407
...
end smallest_y_for_prime_abs_quadratic_l3204_320407


namespace average_price_decrease_l3204_320406
...
end average_price_decrease_l3204_320406


namespace set_operations_l3204_320486
...
end set_operations_l3204_320486


namespace hyperbola_focus_coincides_with_parabola_focus_l3204_320495
...
end hyperbola_focus_coincides_with_parabola_focus_l3204_320495


namespace solution_x_equals_two_l3204_320465

theorem solution_x_equals_two : 
  ∃ x : ℝ, x = 2 ∧ 7 * x - 14 = 0 := by
sorry

end solution_x_equals_two_l3204_320465


namespace simplify_fraction_l3204_320461

theorem simplify_fraction (x : ℝ) (h : x ≠ 2) :
  (1 + 1 / (x - 2)) / ((x - x^2) / (x - 2)) = -(x - 1) / x := by
  sorry

end simplify_fraction_l3204_320461


namespace master_craftsman_production_l3204_320487
...
end master_craftsman_production_l3204_320487


namespace loan_repayment_amount_l3204_320481
...
end loan_repayment_amount_l3204_320481


namespace journey_with_four_encounters_takes_five_days_l3204_320439
...
end journey_with_four_encounters_takes_five_days_l3204_320439


namespace will_money_distribution_l3204_320440
...
end will_money_distribution_l3204_320440


namespace inequality_proof_l3204_320462
...
end inequality_proof_l3204_320462


namespace solution_set_theorem_l3204_320413
...
end solution_set_theorem_l3204_320413


namespace gcd_84_120_l3204_320490

theorem gcd_84_120 : Nat.gcd 84 120 = 12 := by
  sorry

end gcd_84_120_l3204_320490


namespace ratio_of_numbers_l3204_320430

theorem ratio_of_numbers (x y : ℝ) (hx : x > 0) (hy : y > 0) (hxy : x > y) 
  (sum_diff : x + y = 7 * (x - y)) : x / y = 4 / 3 := by
  sorry

end ratio_of_numbers_l3204_320430


namespace solve_for_m_l3204_320485
...
end solve_for_m_l3204_320485


namespace worker_earnings_l3204_320418
...
end worker_earnings_l3204_320418


namespace paris_study_time_l3204_320449
...
end paris_study_time_l3204_320449


namespace hockey_league_games_l3204_320416
...
end hockey_league_games_l3204_320416


namespace A_power_50_l3204_320422

def A : Matrix (Fin 2) (Fin 2) ℤ := !![5, 1; -16, -3]

theorem A_power_50 : A^50 = !![201, 50; -800, -199] := by sorry

end A_power_50_l3204_320422


namespace perpendicular_lines_m_values_l3204_320476
...
end perpendicular_lines_m_values_l3204_320476


namespace substitution_result_l3204_320423
...
end substitution_result_l3204_320423


namespace negation_equivalence_l3204_320466
...
end negation_equivalence_l3204_320466


namespace kitchen_chairs_count_l3204_320438
...
end kitchen_chairs_count_l3204_320438


namespace sugar_recipe_reduction_l3204_320425
...
end sugar_recipe_reduction_l3204_320425


namespace simplify_expression_l3204_320493

theorem simplify_expression (p : ℝ) : 
  ((5 * p + 1) - 2 * p * 4) * 3 + (4 - 1 / 3) * (6 * p - 9) = 13 * p - 30 := by
  sorry

end simplify_expression_l3204_320493


namespace drama_club_subjects_l3204_320482
...
end drama_club_subjects_l3204_320482


namespace product_of_roots_l3204_320435

theorem product_of_roots (x : ℝ) : (x + 3) * (x - 4) = 22 → ∃ y : ℝ, (x + 3) * (x - 4) = 22 ∧ x * y = -34 := by
  sorry

end product_of_roots_l3204_320435


namespace ellipse_eccentricity_l3204_320401
...
end ellipse_eccentricity_l3204_320401


namespace hyperbola_foci_l3204_320469
...
end hyperbola_foci_l3204_320469


namespace min_value_theorem_l3204_320497
...
end min_value_theorem_l3204_320497


namespace total_shirts_washed_l3204_320410
...
end total_shirts_washed_l3204_320410


namespace divisibility_by_24_l3204_320428

theorem divisibility_by_24 (p : ℕ) (h_prime : Nat.Prime p) (h_ge_5 : p ≥ 5) : 
  (p^2 - 1) % 24 = 0 := by
sorry

end divisibility_by_24_l3204_320428


namespace quadratic_inequality_range_l3204_320419

theorem quadratic_inequality_range (a : ℝ) : 
  (∃ x : ℝ, x^2 + 2*a*x + 1 < 0) ↔ a ∈ Set.Ioi 1 ∪ Set.Iio (-1) :=
sorry

end quadratic_inequality_range_l3204_320419


namespace candy_count_l3204_320460
...
end candy_count_l3204_320460


namespace number_equation_solution_l3204_320424

theorem number_equation_solution : ∃ x : ℝ, (3/5) * x + 7 = (1/4) * x^2 - (1/2) * (1/3) * x := by
  sorry

end number_equation_solution_l3204_320424


namespace razorback_shop_revenue_l3204_320458
...
end razorback_shop_revenue_l3204_320458


namespace smallest_m_for_integral_roots_existence_of_integral_roots_smallest_m_is_195_l3204_320452
...
end smallest_m_for_integral_roots_existence_of_integral_roots_smallest_m_is_195_l3204_320452


namespace purely_imaginary_z_l3204_320479
...
end purely_imaginary_z_l3204_320479


namespace buffalo_count_l3204_320455
...
end buffalo_count_l3204_320455


namespace total_arrangements_l3204_320454
...
end total_arrangements_l3204_320454


namespace infinite_geometric_series_first_term_l3204_320405
...
end infinite_geometric_series_first_term_l3204_320405


namespace complete_graph_4_vertices_6_edges_l3204_320488
...
end complete_graph_4_vertices_6_edges_l3204_320488


namespace four_digit_square_modification_l3204_320456
...
end four_digit_square_modification_l3204_320456


namespace counterexample_exists_l3204_320427

theorem counterexample_exists : ∃ (a b : ℝ), a^2 > b^2 ∧ a ≤ b := by
  sorry

end counterexample_exists_l3204_320427
