...
namespace derivative_sin_2x_at_pi_3_l752_75246
...
end derivative_sin_2x_at_pi_3_l752_75246


namespace consecutive_base_problem_l752_75247
...
end consecutive_base_problem_l752_75247


namespace island_ocean_depth_l752_75257
...
end island_ocean_depth_l752_75257


namespace greatest_divisor_with_remainders_l752_75202
...
end greatest_divisor_with_remainders_l752_75202


namespace quadratic_solution_l752_75223

theorem quadratic_solution (x : ℝ) : x^2 - 4*x + 3 = 0 → x = 1 ∨ x = 3 := by
  sorry

end quadratic_solution_l752_75223


namespace divisibility_by_seven_l752_75232

theorem divisibility_by_seven (n : ℕ) : 
  (3^(12*n^2 + 1) + 2^(6*n + 2)) % 7 = 0 := by
  sorry

end divisibility_by_seven_l752_75232


namespace quartic_two_real_roots_l752_75201
...
end quartic_two_real_roots_l752_75201


namespace unbalanceable_pairs_l752_75214
...
end unbalanceable_pairs_l752_75214


namespace other_group_cleaned_area_l752_75263
...
end other_group_cleaned_area_l752_75263


namespace negation_of_existence_negation_of_inequality_l752_75264
...
end negation_of_existence_negation_of_inequality_l752_75264


namespace parabola_chord_slope_l752_75291
...
end parabola_chord_slope_l752_75291


namespace correct_middle_managers_sample_l752_75224
...
end correct_middle_managers_sample_l752_75224


namespace cosine_cutting_plane_angle_l752_75273
...
end cosine_cutting_plane_angle_l752_75273


namespace two_wheeled_bikes_count_l752_75235
...
end two_wheeled_bikes_count_l752_75235


namespace children_on_bus_l752_75293
...
end children_on_bus_l752_75293


namespace lcm_of_12_and_18_l752_75245

theorem lcm_of_12_and_18 : Nat.lcm 12 18 = 36 := by
  sorry

end lcm_of_12_and_18_l752_75245


namespace eighth_grade_higher_mean_l752_75227
...
end eighth_grade_higher_mean_l752_75227


namespace continued_fraction_simplification_l752_75231

theorem continued_fraction_simplification :
  1 + (3 / (4 + (5 / 6))) = 47 / 29 := by
  sorry

end continued_fraction_simplification_l752_75231


namespace unique_cameras_l752_75213
...
end unique_cameras_l752_75213


namespace forty_fifth_term_is_91_l752_75248
...
end forty_fifth_term_is_91_l752_75248


namespace journey_time_relation_l752_75295
...
end journey_time_relation_l752_75295


namespace probability_white_ball_l752_75258
...
end probability_white_ball_l752_75258


namespace angle_measure_of_extended_sides_l752_75260
...
end angle_measure_of_extended_sides_l752_75260


namespace ladybugs_per_leaf_l752_75277
...
end ladybugs_per_leaf_l752_75277


namespace contractor_daily_wage_l752_75294
...
end contractor_daily_wage_l752_75294


namespace triangle_side_length_l752_75252
...
end triangle_side_length_l752_75252


namespace two_point_six_million_scientific_notation_l752_75285
...
end two_point_six_million_scientific_notation_l752_75285


namespace least_n_for_inequality_l752_75221
...
end least_n_for_inequality_l752_75221


namespace find_divisor_l752_75261
...
end find_divisor_l752_75261


namespace train_length_l752_75265
...
end train_length_l752_75265


namespace mod_equivalence_unique_l752_75206

theorem mod_equivalence_unique : ∃! n : ℤ, 0 ≤ n ∧ n < 23 ∧ -150 ≡ n [ZMOD 23] ∧ n = 11 := by
  sorry

end mod_equivalence_unique_l752_75206


namespace min_beacons_for_unique_determination_l752_75233
...
end min_beacons_for_unique_determination_l752_75233


namespace parallelogram_diagonal_intersection_l752_75226
...
end parallelogram_diagonal_intersection_l752_75226


namespace sequence_product_representation_l752_75280

theorem sequence_product_representation (n a : ℕ) :
  ∃ u v : ℕ, (n : ℚ) / (n + a) = (u : ℚ) / (u + a) * (v : ℚ) / (v + a) := by
  sorry

end sequence_product_representation_l752_75280


namespace golf_problem_l752_75281
...
end golf_problem_l752_75281


namespace all_four_digit_palindromes_divisible_by_11_l752_75254
...
end all_four_digit_palindromes_divisible_by_11_l752_75254


namespace product_equals_four_l752_75229

theorem product_equals_four (m n : ℝ) (h : m + n = (1/2) * m * n) :
  (m - 2) * (n - 2) = 4 := by
  sorry

end product_equals_four_l752_75229


namespace virginia_eggs_problem_l752_75225
...
end virginia_eggs_problem_l752_75225


namespace sticker_problem_l752_75256
...
end sticker_problem_l752_75256


namespace soccer_team_wins_l752_75217
...
end soccer_team_wins_l752_75217


namespace midpoint_sum_and_distance_l752_75230
...
end midpoint_sum_and_distance_l752_75230


namespace sufficiency_of_P_for_Q_l752_75219
...
end sufficiency_of_P_for_Q_l752_75219


namespace missing_number_is_five_l752_75228

theorem missing_number_is_five : ∃ x : ℕ, 10111 - x * 2 * 5 = 10011 ∧ x = 5 := by
  sorry

end missing_number_is_five_l752_75228


namespace probability_at_least_one_juice_l752_75237
...
end probability_at_least_one_juice_l752_75237


namespace giant_spider_leg_pressure_l752_75203
...
end giant_spider_leg_pressure_l752_75203


namespace treasure_hunt_probability_l752_75215
...
end treasure_hunt_probability_l752_75215


namespace perpendicular_slopes_not_always_negative_one_l752_75276
...
end perpendicular_slopes_not_always_negative_one_l752_75276


namespace company_fund_distribution_l752_75267
...
end company_fund_distribution_l752_75267


namespace olivia_remaining_money_l752_75253
...
end olivia_remaining_money_l752_75253


namespace negation_of_existence_proposition_l752_75284

theorem negation_of_existence_proposition :
  (¬ ∃ x : ℝ, x^2 + 2*x + 5 = 0) ↔ (∀ x : ℝ, x^2 + 2*x + 5 ≠ 0) := by
  sorry

end negation_of_existence_proposition_l752_75284


namespace conic_properties_l752_75262
...
end conic_properties_l752_75262


namespace candy_problem_l752_75278

theorem candy_problem (C : ℕ) : 
  (C - (C / 3) - (C - (C / 3)) / 4 + C / 2 - 7 = 16) → C = 23 := by
  sorry

end candy_problem_l752_75278


namespace rabbit_hop_time_l752_75282
...
end rabbit_hop_time_l752_75282


namespace probability_geometric_progression_ratio_two_l752_75241
...
end probability_geometric_progression_ratio_two_l752_75241


namespace bus_passengers_l752_75297
...
end bus_passengers_l752_75297


namespace triangle_area_l752_75283

theorem triangle_area (a b c : ℝ) (h1 : a = 9) (h2 : b = 12) (h3 : c = 15) :
  (1/2) * a * b = 54 := by
  sorry

end triangle_area_l752_75283


namespace min_g_14_l752_75290
...
end min_g_14_l752_75290


namespace price_increase_decrease_l752_75209

theorem price_increase_decrease (x : ℝ) : 
  (100 + x) * (100 - 23.076923076923077) / 100 = 100 → x = 30 := by
sorry

end price_increase_decrease_l752_75209


namespace triangle_properties_l752_75279
...
end triangle_properties_l752_75279


namespace proposition_evaluation_l752_75272
...
end proposition_evaluation_l752_75272


namespace students_not_in_biology_l752_75216
...
end students_not_in_biology_l752_75216


namespace gpa_probability_l752_75298
...
end gpa_probability_l752_75298


namespace carol_owns_twice_as_many_as_cathy_l752_75205
...
end carol_owns_twice_as_many_as_cathy_l752_75205


namespace malcom_remaining_cards_l752_75200
...
end malcom_remaining_cards_l752_75200


namespace fraction_simplification_l752_75292

theorem fraction_simplification :
  (3/7 + 5/8) / (5/12 + 1/3) = 59/42 := by
  sorry

end fraction_simplification_l752_75292


namespace units_digit_product_zero_exists_l752_75259

theorem units_digit_product_zero_exists : ∃ (a b : ℕ), 
  (a % 10 ≠ 0) ∧ (b % 10 ≠ 0) ∧ ((a * b) % 10 = 0) := by
  sorry

end units_digit_product_zero_exists_l752_75259


namespace farmer_livestock_purchase_l752_75218
...
end farmer_livestock_purchase_l752_75218


namespace number_division_problem_l752_75210

theorem number_division_problem : ∃ x : ℚ, (x / 5) - (x / 6) = 30 ∧ x = 900 := by
  sorry

end number_division_problem_l752_75210


namespace exists_divisible_power_minus_one_l752_75234

theorem exists_divisible_power_minus_one (n : ℕ) (h_odd : Odd n) (h_gt_one : n > 1) :
  ∃ k : ℕ, k > 0 ∧ k < n ∧ (n ∣ 2^k - 1) := by
  sorry

end exists_divisible_power_minus_one_l752_75234


namespace complex_number_quadrant_l752_75208
...
end complex_number_quadrant_l752_75208


namespace berry_picking_difference_l752_75211
...
end berry_picking_difference_l752_75211


namespace bicyclists_meet_at_1030_l752_75270
...
end bicyclists_meet_at_1030_l752_75270


namespace smallest_n_for_inequality_l752_75239
...
end smallest_n_for_inequality_l752_75239


namespace fan_shaped_segment_edge_length_l752_75238
...
end fan_shaped_segment_edge_length_l752_75238


namespace no_real_solutions_l752_75204

theorem no_real_solutions : ¬∃ (x y z : ℝ), (x + y = 3) ∧ (x * y + 2 * z^2 = 5) := by
  sorry

end no_real_solutions_l752_75204


namespace negation_of_forall_geq_one_l752_75250

theorem negation_of_forall_geq_one :
  (¬ (∀ x : ℝ, x ≥ 1)) ↔ (∃ x : ℝ, x < 1) :=
by sorry

end negation_of_forall_geq_one_l752_75250


namespace power_comparison_specific_power_comparison_l752_75240
...
end power_comparison_specific_power_comparison_l752_75240


namespace system_solution_l752_75271
...
end system_solution_l752_75271


namespace seating_arrangements_l752_75249
...
end seating_arrangements_l752_75249


namespace matrix_equality_l752_75207
...
end matrix_equality_l752_75207


namespace intersection_of_M_and_P_l752_75268
...
end intersection_of_M_and_P_l752_75268


namespace permutation_combination_inequality_l752_75286

theorem permutation_combination_inequality (n : ℕ+) :
  (n.val.factorial / (n.val - 2).factorial)^2 > 6 * (n.val.choose 4) ↔ n.val ∈ ({2, 3, 4} : Finset ℕ) :=
sorry

end permutation_combination_inequality_l752_75286


namespace good_number_properties_l752_75220
...
end good_number_properties_l752_75220


namespace function_extension_theorem_l752_75242
...
end function_extension_theorem_l752_75242


namespace not_in_third_quadrant_l752_75244
...
end not_in_third_quadrant_l752_75244


namespace student_council_committees_l752_75289
...
end student_council_committees_l752_75289


namespace polygon_number_formula_l752_75275
...
end polygon_number_formula_l752_75275


namespace angle_at_two_fifteen_l752_75255
...
end angle_at_two_fifteen_l752_75255


namespace hyperbola_eccentricity_l752_75251
...
end hyperbola_eccentricity_l752_75251


namespace sum_of_four_numbers_l752_75287

theorem sum_of_four_numbers : 1234 + 2341 + 3412 + 4123 = 11110 := by
  sorry

end sum_of_four_numbers_l752_75287


namespace five_polyhedra_types_l752_75236
...
end five_polyhedra_types_l752_75236


namespace pies_sold_weekend_l752_75243
...
end pies_sold_weekend_l752_75243


namespace dave_bought_26_tshirts_l752_75274
...
end dave_bought_26_tshirts_l752_75274


namespace negative_three_squared_minus_negative_two_cubed_l752_75212

theorem negative_three_squared_minus_negative_two_cubed : (-3)^2 - (-2)^3 = 17 := by
  sorry

end negative_three_squared_minus_negative_two_cubed_l752_75212


namespace probability_closer_to_five_than_one_l752_75269
...
end probability_closer_to_five_than_one_l752_75269


namespace pentadecagon_diagonals_l752_75296
...
end pentadecagon_diagonals_l752_75296


namespace digit_square_problem_l752_75299
...
end digit_square_problem_l752_75299


namespace right_triangle_existence_l752_75288
...
end right_triangle_existence_l752_75288


namespace carrot_distribution_l752_75222
...
end carrot_distribution_l752_75222


namespace value_of_expression_l752_75266

theorem value_of_expression (x y : ℝ) (h : |x - 2| + (y + 3)^2 = 0) : (x + y)^2023 = -1 := by
  sorry

end value_of_expression_l752_75266
